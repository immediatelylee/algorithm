var slotMachine = {
	...
	spinURL: './slots/spin.php?' +  Math.random()  , // point to the server component to call to get spin results.
	...
	init: function() {
		$('#betSpinUp').click(function() { slotMachine.change_bet(+10); });
		$('#betSpinDown').click(function() { slotMachine.change_bet(-10); });
